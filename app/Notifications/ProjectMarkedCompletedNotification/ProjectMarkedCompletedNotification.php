...
class ProjectMarkedCompletedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject("Project {$this->contract_title} Marked as Completed")
            ->view('mail.project_marked_completed.milestone-project-marked-completed', [
    ...
    {
        return [
            'message' => "Project {$this->contract_title} Marked as Completed",
        ];
    }
}
