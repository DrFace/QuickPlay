...
class PaymentReceivedNextMilestoneNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject("Payment Received for the Milestone on {$this->contract_title}")
            ->view('mail.payment_received_next_milestone.payment-received-next-milestone', [
    ...
    {
        return [
            'message' => 'Payment Received for the Milestone ',
        ];
    }
}
