...
<body style="font-family: Arial, sans-serif; background-color: #f7f7f7; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333; margin-top: 30px;">We are thrilled to have you join AI Geeks! Whether you are here to explore, collaborate, or grow, we’re excited to support your journey.</p>
            <p style="font-size: 16px; color: #333; margin-top: 20px;">If you have any questions or need assistance, our support team is here to help. Feel free to reach out anytime.</p>
            <p style="font-size: 16px; color: #333; margin-top: 30px;">Thank you for choosing AI Geeks!</p>
