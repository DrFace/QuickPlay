...
<body style="font-family: Arial, sans-serif; background-color: #f7f7f7; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333;">Hello <strong>{{ $freelancer_name }}</strong>,</p>
            <p>Great news! Your payout request has been approved by the admin. The payment will be processed shortly, and the amount will be transferred to your designated account.</p>
