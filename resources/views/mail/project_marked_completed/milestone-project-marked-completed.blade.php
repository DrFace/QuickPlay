...
<head>
    ...
    <title>Milestone Project Marked as Completed</title>
</head>
    ...
    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 30px;">
            <h1 style="font-size: 22px; color: #333; margin-bottom: 20px; border-bottom: 1px solid #e0e0e0; padding-bottom: 10px; text-align: center;">
                Milestone Project Marked as Completed
            </h1>
            <p style="font-size: 16px; color: #333;">Hello <strong>{{ $freelancer_first_name }}</strong>,</p>
            <p>Congratulations! The client <strong>{{ $first_name }}</strong> has marked the milestone project <strong>{{ $contract_title }}</strong> as completed.</p>
