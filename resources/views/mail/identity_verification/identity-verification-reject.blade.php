...
<body style="font-family: Arial, sans-serif; background-color: #f7f7f7; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333; margin-top: 30px;">Unfortunately, your recent ID verification submission has been rejected.
                Reason for Rejection: <strong>{{ $reason }}</strong>.</p>
            <p style="font-size: 16px; color: #333; margin-top: 20px;">Kindly review the provided feedback and resubmit your ID verification at your earliest convenience.</p>
