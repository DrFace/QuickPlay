...
<head>
    ...
    <title>Ai-Geeks Email Change Confirmation</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #f7f7f7; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333; margin-top: 30px;">We would like to inform you that your email has been successfully changed to <strong style="color: #0073e6;">{{ $email }}</strong>.</p>
