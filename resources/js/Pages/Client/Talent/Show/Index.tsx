            ...
            <AppLayout isClientHeader={true} isHeader={false} isFooter={true} >
                ...
                <section className="flex justify-center min-h-screen px-4 py-20 mt-20 bg-white sm:px-6 lg:px-8 ">
                    <div className="w-full h-full ">
                        ...
                        <div className="p-6">
                            <div className="flex px-6 py-8 border-2 rounded-t-3xl">
                                <div className="relative flex items-start w-20 gap-4 mr-5">
                                    <div className={`absolute w-3 h-3  rounded-full left-1 top-1 ring-2 ring-white ${freelancer?.active_status ? "bg-green-500" : "bg-red-500"}`}></div>
                                    <img
                                ...
                                <div className="flex flex-col w-full gap-4">
                                    <div className="flex flex-col justify-between w-full gap-4 sm:flex-row">
                                        <div className="flex flex-col gap-2 sm:w-1/2 text-start">
                                            <div className="flex flex-col gap-4">
                                                <span className="text-xl font-semibold font-Inter ">{freelancer?.full_name}</span>
                                                <div className="flex items-center gap-2 text-sm font-medium text-textSecondary">
                                                    ...
                                                    <span className=""> {freelancer?.country} - {freelancer?.user_country_time}</span>
                                                </div>

                                            </div>

                                        </div>
                                        {/* <div className="flex justify-end w-1/2 h-auto gap-3 ">
                                            <button className="flex items-center w-auto gap-2 px-4 py-2 font-semibold text-primary border-primary">
                                            <span className="text-blue-600">Share</span>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M14.0003 8.00017L8.49911 2.74902V5.74968C3.23452 5.74968 1.99769 9.52456 1.99769 13.2513C3.51708 11.3059 4.86081 10.2507 8.49911 10.2507V13.2513L14.0003 8.00017Z" stroke="#004AAD" stroke-width="1.00189" stroke-linejoin="round"/>
                                                </svg>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-base font-semibold ">{freelancer?.job_success}% Job Success</span>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div className="flex flex-col border-b-2 border-l-2 border-r-2 lg:flex-row text-start ">
                                <div className="flex flex-col w-full gap-2 border-r-2 lg:w-1/3">
                                    <div className="flex flex-row justify-between p-4 ">
                                        <div className="flex flex-col w-1/2 gap-2 text-start">
                                            <h3 className='text-2xl font-medium font-Inter'>$ {formatNumber(freelancer?.earned)}</h3>
                                            <span className='text-sm font-medium font-Inter text-textSecondary'>Total earnings</span>
                                        </div>
                                        <div className='flex flex-col text-left '>
                                            <h3 className='font-medium sm:text-2xl font-Inter' >{freelancer?.active_offer_count}</h3>
                                            <span className='font-medium sm:text-sm font-Inter text-textSecondary'>Total jobs</span>
                                        </div>
                                    ...
                                    <div className="flex flex-col justify-between gap-6 p-4">
                                        <div className='flex flex-col gap-3 text-start'>
                                            ...
                                            {freelancer?.language?.map((language: any, index: number) => (
                                        ...
                                        <div className='flex flex-col text-start'>
                                            ...
                                            {freelancer?.educations.map((education: any, index: number) => (
                                ...
                                <div className="flex flex-col w-full md:p-8 ">
                                    ...
                                    <div className='flex flex-col gap-4 p-8 border-b-2'>
                                        <div>
                                            <h1 className='text-lg font-semibold break-words md:text-xl font-Inter'>
                                                {freelancer?.meta_data?.title || 'Title not updated'}
                                            </h1>
                                        </div>
                                        <div>
                                            <DescriptionWidget title='' description={freelancer?.meta_data?.profile_overview} attachments={[]} id={1} />
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex flex-col gap-4 p-8 border-b-2'>
                                        ...
                                        {selectedWorkHistory === 'completed' ? (
                                            <div className='flex flex-col py-4 border-b-2'>
                                                {freelancer?.recent_reviews?.length > 0 ? (
                                                    freelancer?.recent_reviews?.map((review: any) => (
                                            ...
                                            <>
                                                {freelancer?.in_progress_offers?.length > 0 ? (
                                                    freelancer?.in_progress_offers?.map((offer: any) => (
                                                        <div className='flex flex-col py-4 border-b-2'>
                                                            <div>
                                    ...
                                    <div className='flex flex-col gap-4 p-8 border-b-2'>
                                        <div>
                                            ...
                                            <PortfolioCarouselView activePortfolios={freelancer.portfolios} />
                                        </div>
                                    ...
                                    <div className='flex flex-col gap-4 p-8 '>
                                        <div>
                                            <h1 className='text-xl font-semibold font-Inter'>Skills</h1>
                                        </div>
                                        <SkillWidget skills={freelancer?.skills} title="" />
                                    </div>
