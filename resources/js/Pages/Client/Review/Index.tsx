...
export default function OfferReview({
    ...
    const { data, setData, post, errors, progress, reset } = useForm({
        recommend_rate: offer.freelancer_recommend_rate ?? 0,
        feedback: offer.freelancer_feedback ?? '',
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('client.contracts.review-submit', offer?.id),
            {
                preserveScroll: true,
                onSuccess: () => {
    ...
    const reasons = [
        ...
        {
            value: 'problem_working_with_freelancer',
            label: 'Problem working with freelancer'
        },
        {
        ...
        {
            value: 'freelancer_no_longer_available',
            label: 'Freelancer is no longer available'
        },
        {
                            ...
                            <div className="flex flex-col w-full gap-4 lg:w-3/4">
                                <div className="flex flex-col gap-4 ">
                                    ...
                                    <div className="flex flex-col gap-8">
                                        <div className="flex flex-col gap-4">
                                            <p className="text-left">This is your opportunity to share feedback on {offer?.freelancer?.first_name} that you don’t want posted publicly. We’ll use it to improve the user experience, but we won’t share it with {offer?.freelancer?.first_name}.</p>
                                            <div className="flex flex-col justify-start w-3/4 gap-3 text-left">
                                                <div className="flex flex-row gap-2">
                                                    <InputLabel required htmlFor="recommend_rate" value="How likely are you to recommend this freelancer to a friend or a colleague ?" />
                                                </div>

                                                <div className="flex flex-row justify-center gap-2 ml-5">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <div className="flex flex-col justify-start gap-6 text-left sm:w-3/4">
                                                <div className="flex flex-col gap-2 ">
                                                    <InputLabel required htmlFor="feedback" value="Do you have any feedback on the freelancer? " />
                                                    <div>
                                                        <TextArea
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <div className="w-full">
                                                        <InputLabel required className="text-base font-bold text-black w- font-Inter" htmlFor="contract_end_reason" value="Can you tell us your primary reason for ending this contract?" />
                                                        <SelectInput
                                        ...
                                        <div className="flex flex-col gap-4">
                                            ...
                                            <div className="flex flex-col justify-start gap-3 text-left sm:w-3/4">
                                                <div className="flex flex-col sm:gap-2">
                                                    <div className="flex flex-col-reverse justify-start gap-1 sm:flex-row sm:items-center">
                                                        ...
                                                        <span className="mt-1.5 sm:pl-5 text-base font-bold  text-start font-Inter ">
                                                            Skills
                                                        </span>
                                                    </div>
                                                    <div className="flex flex-col-reverse justify-start gap-1 sm:flex-row sm:items-center ">
                                                        ...
                                                        <span className="mt-1.5 text-base font-bold sm:pl-5 text-start font-Inter ">
                                                            Quality of Work
                                                        </span>
                                                    </div>
                                                    <div className="flex flex-col-reverse justify-start gap-1 sm:flex-row sm:items-center ">
                                        ...
                                        <div className="flex flex-col justify-between w-full gap-4 sm:items-center sm:flex-row">
                                            <div className="flex flex-col gap-2 text-start">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-sm font-semibold font-Inter ">{offer?.freelancer?.meta_data?.title || 'Title not update'}</span>
                                                    <span className="text-sm font-normal text-textSecondary font-Inter">{offer?.freelancer?.country}</span>
                                                    <span className="text-sm font-medium text-gray-500 font-Inter">{offer?.freelancer?.user_country_time}</span>
                                                </div>
                                            </div>
                                        </div>
