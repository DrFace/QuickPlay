...
const AiTipsComponent = ({
    ...
    const handleGenerateTips = async () => {
        if (text) {
            setProcessing(true);
            const response = await fetch(`/client/ai-tips/${text}`);
            if (response.ok) {
    ...
    return (
        <div className="">
            <InputLabel required  className="text-base font-bold text-black font-Inter"  value="Describe what you need " />
            <div className="mt-2 border-4 rounded-3xl">
                ...
                <div className="">
                    <TextArea
                        ...
                        placeholder="Write a description of your project here"
                        rows={8}
                        onChange={(e) => {
