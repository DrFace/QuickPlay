...
export default function HireProposals({
    filters,
    proposals,
    job,
}: {
                ...
                <div className="flex flex-col ">
                    {proposals?.data?.length === 0 && (
                        <div className="flex flex-col gap-4 py-10 sm:gap-8">
                            <span className="text-lg font-semibold text-gray-500">No hired proposals yet</span>
                        </div>
                    )}
                                ...
                                <div className="flex flex-col justify-between w-full gap-4 sm:items-center sm:flex-row">
                                    <div className="flex flex-col gap-2 text-start">
                                        <div className="flex items-center gap-4 ">
                                            <div className="relative flex items-start w-28 sm:gap-4 sm:mr-5 sm:hidden ">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-sm font-semibold text-gray-500">{proposal?.freelancer?.country}</span>
                                            </div>
                                    ...
                                    <div className="flex justify-end gap-3">
                                        ...
                                        <Link
                                            type="button"
                                            href={route('client.offer.show', proposal?.offer_id)}
                                            onClick={(e) => e.stopPropagation()}
