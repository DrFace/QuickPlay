                        ...
                        <div className="p-6">
                                        ...
                                        <div className="flex flex-row w-full gap-2 lg:w-2/3 text-start">
                                            <div className="relative items-start gap-4 mr-5 sm:w-20 ">
                                                ...
                                                <img
                                                    ...
                                                    src={freelancer?.data?.avatar}
                                                    alt="avatar"
                                                />
                                            </div>
                                            <div className='flex flex-col'>
                                                <div className="flex flex-col gap-2">
                                                    <span className="text-xl font-semibold font-Inter ">{freelancer?.data?.full_name} </span>
                                                    <div className="flex items-center gap-2 text-sm font-medium text-textSecondary">
                                                        ...
                                                        <span className="">{freelancer?.data?.country}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 text-sm font-medium text-textSecondary">
                                                        <span className="">{freelancer?.data?.user_country_time}</span>
                                                    </div>

                                                </div>
                                                <div className="flex flex-col gap-4 md:flex-row">
                                                    {/* <Link
                                                        href={route('client.freelancer.show', freelancer?.id)}
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-xs font-semibold sm:text-base ">{freelancer?.data?.job_success}% Job Success</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex justify-end w-full gap-3 lg:w-1/3">
                                            <div className="justify-end">
                                                <div className='flex gap-3'>
                                                    <Link
                                                        type="button"
                                                        href={`/client/messages/${proposal?.data?.id}`}
                                                        onClick={(e) => e.stopPropagation()}
                                                        className="px-8 py-1 font-semibold border-2 sm:py-3 rounded-3xl text-primary border-primary">
                                                        Message
                                                    </Link>
                                                    {proposal?.data?.proposal_status == 'submitted' &&
                                                        <Link
                                                            type="button"
                                                            href={`/client/offer/job/${proposal?.data?.job_post_id}/proposal/${proposal?.data?.id}`}
                                                            onClick={(e) => e.stopPropagation()}
                                                            className="px-8 py-1 text-base font-semibold text-white sm:py-3 rounded-3xl font-Inter bg-primary">
                                                            Hire
                                                        </Link>
                                                    }
                                                </div>
                            ...
                            <div className="flex flex-col border-2 border-t-0 lg:flex-row text-start rounded-b-3xl">
                                <div className="flex flex-col w-full gap-1 p-4 border-b-2 lg:border-b-0 lg:w-1/3 lg:border-r-2">
                                    ...
                                    <p className='text-base font-normal font-Inter'>{freelancer?.data?.first_name} has applied to your job </p>
                                    <span className='font-semibold text-black'>{jobTitle}</span>
                                </div>
                                <div className="flex flex-col w-full p-4 sm:p-6 lg:w-2/3">
                                    <div className="flex flex-col gap-4 py-3 border-b-2 sm:py-8 sm:flex-row sm:justify-between">
                                        ...
                                        <div className='flex flex-col w-full sm:items-center '>
                                            <h3 className='text-2xl font-medium font-Inter' >$ {proposal?.data?.bid_amount}</h3>
                                            <p className='text-sm font-medium font-Inter text-textSecondary'>Proposed Bid</p>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-4 py-3 ">
                                        <DescriptionWidget description={proposal?.data?.description} attachments={proposal?.data?.attachments} id={proposal?.data?.id} title='Cover Letter' />
                                    </div>
                                </div>
                            </div>


                            <div className="flex flex-row mt-6 border-2 text-start rounded-3xl">
                                <div className="flex flex-col w-1/3 gap-2 border-r-2">
                                    <div className="flex flex-row justify-between p-4 border-b-2">
                                        <div className="flex flex-col w-1/2 gap-2 text-start">
                                            <h3 className='text-2xl font-medium font-Inter'>$ {formatNumber(freelancer?.data?.earned)}</h3>
                                            <span className='text-sm font-medium font-Inter text-textSecondary'>Total earnings</span>
                                        </div>
                                        <div className='flex flex-col text-left '>
                                            <h3 className='text-2xl font-medium font-Inter' >{freelancer?.data?.active_offer_count}</h3>
                                    ...
                                    <div className="flex flex-col justify-between gap-6 p-4">
                                        <div className='flex flex-col gap-3 text-start'>
                                            ...
                                            {freelancer?.data?.language?.length > 0 ? (
                                            freelancer?.data?.language?.map((language: any, index: number) => (
                                            ...
                                            <div className="flex items-center justify-center w-full py-3">
                                                <p className="text-sm font-normal text-gray-400 text-start font-Inter">No language available</p>
                                            </div>
                                        )}
                                        </div>
                                        {/* <div className='flex flex-col gap-3 text-start'>
                                        ...
                                        <div className='flex flex-col text-start'>
                                            ...
                                            {freelancer?.data?.educations.length > 0 ? (
                                                freelancer?.data?.educations.map((education: any, index: number) => (
                                                ...
                                                <div className="flex items-center justify-center w-full py-3">
                                                    <p className="text-sm font-normal text-gray-400 text-start font-Inter">No education available</p>
                                                </div>
                                            )}
                                ...
                                <div className="flex flex-col w-2/3 ">
                                    ...
                                    <div className='flex flex-col gap-4 p-8 border-b-2'>
                                        <div>
                                            <h1 className='text-xl font-semibold font-Inter'>{freelancer?.data?.meta_data?.title || 'Title not update'}</h1>
                                        </div>
                                        <div>
                                            <DescriptionWidget title='' description={freelancer?.data?.meta_data?.profile_overview} attachments={[]} id={proposal?.id} />
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex flex-col gap-4 p-8 border-b-2'>
                                        ...
                                        {selectedWorkHistory === 'completed' ? (
                                            <div className='flex flex-col py-4 border-b-2'>
                                                {freelancer?.data?.recent_reviews?.length > 0 ? (
                                                    freelancer?.data?.recent_reviews?.map((review: any) => (
                                            ...
                                            <>
                                                {freelancer?.data?.in_progress_offers?.length > 0 ? (
                                                    freelancer?.data?.in_progress_offers?.map((offer: any) => (
                                                        <div className='flex flex-col py-4 border-b-2'>
                                                            <div>
                                    ...
                                    <div className='flex flex-col gap-4 p-8 border-b-2'>
                                        <div>
                                            ...
                                            <PortfolioCarouselView activePortfolios={freelancer?.data?.portfolios} />
                                        </div>


                                    </div>
                                    <div className='flex flex-col gap-4 p-4 '>
                                        <SkillWidget skills={freelancer?.data?.skills} title='Skills' />
                                    </div>
