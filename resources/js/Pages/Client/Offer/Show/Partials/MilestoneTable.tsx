...
const MilestoneTable = ({
    ...
    return (
        <div className="overflow-x-auto">
            <table className="min-w-full bg-white border border-gray-300">
                <thead className="bg-gray-200">
                    <tr>
                        ...
                        <th className="px-4 py-2 border-b whitespace-nowrap">Add New</th>
                    </tr>
                </thead>
                <tbody>
                    {milestones.map((milestone, index) => (
                        <tr key={milestone.id}>
                            ...
                            <td className="px-4 py-2 text-center border-b ">
                                {(milestone.status !== 'completed' && milestone?.status !== 'requested') &&
                                    <div className="flex items-center justify-center w-full">
                                        ...
                                        <button
                                            onClick={() => openEditModal(index, 'edit', milestone)}
                                            type='button' className="flex text-center">
            ...
            {isEditModalOpen && (
                <EditMilestone onClose={closeModal} milestone={selectedMilestone}
