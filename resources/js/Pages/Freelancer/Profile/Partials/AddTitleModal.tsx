...
const AddTitleModal = (
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('freelancer.title.update'),
            {
                preserveScroll: true,
                onSuccess: () => {
                    setProcessing(false);
    ...
    return (
        <div className="fixed inset-0 z-20 flex items-center justify-center bg-black bg-opacity-50">
            <div className="w-3/4 p-6 bg-white rounded-lg md:w-2/3 lg:w-1/2">
                ...
                <span className="flex py-4 text-sm text-gray-500">Enter a single sentence description of your professional skills/experience (e.g. Expert Web Designer with Ajax experience)</span>
